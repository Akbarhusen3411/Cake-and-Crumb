...
export const products = [
  ...
  // Classic
  { id: 'cs-strawberry', name: 'Strawberry Cheesecake Slice', shortName: 'Strawberry', category: 'cheesecake', subcategory: 'slice', price: 90, unit: 'slice', image: img('/images/real-strawberry-cheesecake.jpg'), description: 'Classic NY-style with fresh strawberry compote', inStock: true, isBestseller: true },
  { id: 'cs-blueberry', name: 'Blueberry Cheesecake Slice', shortName: 'Blueberry', category: 'cheesecake', subcategory: 'slice', price: 90, unit: 'slice', image: img('/images/blueberry-cheesecake.jpg'), description: 'Creamy cheesecake topped with blueberry sauce', inStock: true, isBestseller: false },
  { id: 'cs-raspberry', name: 'Raspberry Cheesecake Slice', shortName: 'Raspberry', category: 'cheesecake', subcategory: 'slice', price: 90, unit: 'slice', image: img('/images/raspberry-cake.jpg'), description: 'Tangy raspberry coulis on velvety cheesecake', inStock: true, isBestseller: false },
  { id: 'cs-cherry', name: 'Cherry Cheesecake Slice', shortName: 'Cherry', category: 'cheesecake', subcategory: 'slice', price: 90, unit: 'slice', image: img('/images/cherry-dessert.jpg'), description: 'Rich cherry compote over smooth cheesecake', inStock: true, isBestseller: false },
  { id: 'cs-lemon', name: 'Lemon Cheesecake Slice', shortName: 'Lemon', category: 'cheesecake', subcategory: 'slice', price: 90, unit: 'slice', image: img('/images/real-lemon-cheesecake.jpg'), description: 'Bright lemon curd on a buttery biscuit base', inStock: true, isBestseller: false },

  // Exotic
  { id: 'cs-mango', name: 'Mango Cheesecake Slice', shortName: 'Mango', category: 'cheesecake', subcategory: 'slice', price: 100, unit: 'slice', image: img('/images/mango-dessert.jpg'), description: 'Tropical Alphonso mango on creamy base', inStock: true, isBestseller: true },
  { id: 'cs-passionfruit', name: 'Passion Fruit Cheesecake Slice', shortName: 'Passion Fruit', category: 'cheesecake', subcategory: 'slice', price: 100, unit: 'slice', image: img('/images/passion-fruit.jpg'), description: 'Exotic passion fruit with a tangy twist', inStock: true, isBestseller: false },
  { id: 'cs-coconut', name: 'Coconut Cheesecake Slice', shortName: 'Coconut', category: 'cheesecake', subcategory: 'slice', price: 100, unit: 'slice', image: img('/images/coconut-dessert.jpg'), description: 'Creamy coconut-infused cheesecake', inStock: true, isBestseller: false },
  { id: 'cs-guava', name: 'Guava Cheesecake Slice', shortName: 'Guava', category: 'cheesecake', subcategory: 'slice', price: 100, unit: 'slice', image: img('/images/guava-dessert.jpg'), description: 'Sweet Indian guava topping on smooth base', inStock: true, isBestseller: false },
  { id: 'cs-mango-passion', name: 'Mango & Passion Cheesecake Slice', shortName: 'Mango & Passion', category: 'cheesecake', subcategory: 'slice', price: 110, unit: 'slice', image: img('/images/mango-dessert.jpg'), description: 'The best of both tropical worlds', inStock: true, isBestseller: false },
  { id: 'cs-orange', name: 'Orange Creamsicle Cheesecake Slice', shortName: 'Orange Creamsicle', category: 'cheesecake', subcategory: 'slice', price: 110, unit: 'slice', image: img('/images/orange-dessert.jpg'), description: 'Nostalgic orange-vanilla swirl', inStock: true, isBestseller: false },

  // Chocolate
  { id: 'cs-choc-orange', name: 'Chocolate Orange Cheesecake Slice', shortName: 'Chocolate Orange', category: 'cheesecake', subcategory: 'slice', price: 115, unit: 'slice', image: img('/images/chocolate-cake-rich.jpg'), description: 'Dark chocolate meets zesty orange', inStock: true, isBestseller: false },
  { id: 'cs-blackforest', name: 'Black Forest Cheesecake Slice', shortName: 'Black Forest', category: 'cheesecake', subcategory: 'slice', price: 115, unit: 'slice', image: img('/images/black-forest-cake.jpg'), description: 'Chocolate, cherry & cream classic reimagined', inStock: true, isBestseller: false },
  { id: 'cs-choc-chunk', name: 'Chocolate Chunk Cheesecake Slice', shortName: 'Choc Chunk', category: 'cheesecake', subcategory: 'slice', price: 115, unit: 'slice', image: img('/images/chocolate-cake-rich.jpg'), description: 'Loaded with premium chocolate chunks', inStock: true, isBestseller: false },
  { id: 'cs-chocolate', name: 'Chocolate Cheesecake Slice', shortName: 'Chocolate', category: 'cheesecake', subcategory: 'slice', price: 115, unit: 'slice', image: img('/images/real-chocolate-cake.jpg'), description: 'Milk & dark chocolate double layer', inStock: true, isBestseller: true },
  { id: 'cs-nutella', name: 'Nutella Cheesecake Slice', shortName: 'Nutella', category: 'cheesecake', subcategory: 'slice', price: 120, unit: 'slice', image: img('/images/nutella-dessert.jpg'), description: 'Swirled with real Nutella throughout', inStock: true, isBestseller: true },
  { id: 'cs-biscoff', name: 'Biscoff Cheesecake Slice', shortName: 'Biscoff', category: 'cheesecake', subcategory: 'slice', price: 120, unit: 'slice', image: img('/images/biscoff-cake.jpg'), description: 'Lotus Biscoff cookie butter bliss', inStock: true, isBestseller: true },

  // Premium
  { id: 'cs-cookies-cream', name: 'Cookies & Cream Cheesecake Slice', shortName: 'Cookies & Cream', category: 'cheesecake', subcategory: 'slice', price: 125, unit: 'slice', image: img('/images/cookies-cream-cake.jpg'), description: 'Crushed Oreo cookies in every bite', inStock: true, isBestseller: false },
  { id: 'cs-caramel', name: 'Caramel Cheesecake Slice', shortName: 'Caramel', category: 'cheesecake', subcategory: 'slice', price: 125, unit: 'slice', image: img('/images/caramel-dessert.jpg'), description: 'Salted caramel drizzle on buttery base', inStock: true, isBestseller: false },
  { id: 'cs-coffee', name: 'Coffee Cheesecake Slice', shortName: 'Coffee', category: 'cheesecake', subcategory: 'slice', price: 125, unit: 'slice', image: img('/images/coffee-cake.jpg'), description: 'Real espresso-infused cheesecake', inStock: true, isBestseller: false },
  { id: 'cs-pistachio', name: 'Pistachio Cheesecake Slice', shortName: 'Pistachio', category: 'cheesecake', subcategory: 'slice', price: 140, unit: 'slice', image: img('/images/pistachio-dessert.jpg'), description: 'Premium pistachio paste swirl', inStock: true, isBestseller: false },

  // ─── Cheesecake — Whole (6 inch) ───
  { id: 'cw-strawberry', name: 'Strawberry Cheesecake (Whole)', shortName: 'Strawberry Whole', category: 'cheesecake', subcategory: 'whole', price: 700, unit: 'whole', image: img('/images/real-strawberry-cheesecake.jpg'), description: 'Full 6-inch strawberry cheesecake', inStock: true, isBestseller: true },
  { id: 'cw-blueberry', name: 'Blueberry Cheesecake (Whole)', shortName: 'Blueberry Whole', category: 'cheesecake', subcategory: 'whole', price: 700, unit: 'whole', image: img('/images/blueberry-cheesecake.jpg'), description: 'Full 6-inch blueberry cheesecake', inStock: true, isBestseller: false },
  { id: 'cw-mango', name: 'Mango Cheesecake (Whole)', shortName: 'Mango Whole', category: 'cheesecake', subcategory: 'whole', price: 800, unit: 'whole', image: img('/images/mango-dessert.jpg'), description: 'Full 6-inch mango cheesecake', inStock: true, isBestseller: false },
  { id: 'cw-chocolate', name: 'Chocolate Cheesecake (Whole)', shortName: 'Chocolate Whole', category: 'cheesecake', subcategory: 'whole', price: 900, unit: 'whole', image: img('/images/chocolate-cake-rich.jpg'), description: 'Full 6-inch chocolate cheesecake', inStock: true, isBestseller: false },
  { id: 'cw-nutella', name: 'Nutella Cheesecake (Whole)', shortName: 'Nutella Whole', category: 'cheesecake', subcategory: 'whole', price: 950, unit: 'whole', image: img('/images/nutella-dessert.jpg'), description: 'Full 6-inch Nutella cheesecake', inStock: true, isBestseller: false },
  { id: 'cw-biscoff', name: 'Biscoff Cheesecake (Whole)', shortName: 'Biscoff Whole', category: 'cheesecake', subcategory: 'whole', price: 950, unit: 'whole', image: img('/images/biscoff-cake.jpg'), description: 'Full 6-inch Biscoff cheesecake', inStock: true, isBestseller: true },
  { id: 'cw-cookies-cream', name: 'Cookies & Cream Cheesecake (Whole)', shortName: 'Cookies & Cream Whole', category: 'cheesecake', subcategory: 'whole', price: 1000, unit: 'whole', image: img('/images/cookies-cream-cake.jpg'), description: 'Full 6-inch Cookies & Cream cheesecake', inStock: true, isBestseller: false },
  { id: 'cw-pistachio', name: 'Pistachio Cheesecake (Whole)', shortName: 'Pistachio Whole', category: 'cheesecake', subcategory: 'whole', price: 1100, unit: 'whole', image: img('/images/pistachio-dessert.jpg'), description: 'Full 6-inch premium pistachio cheesecake', inStock: true, isBestseller: false },
  ...
  // ─── Cookies ───
  { id: 'co-triple-choc', name: 'Triple Chocolate Cookie', shortName: 'Triple Choc', category: 'cookies', subcategory: 'single', price: 65, unit: 'piece', image: img('/images/real-triple-choc-cookies.jpg'), description: 'Dark, milk & white chocolate loaded', inStock: true, isBestseller: true },
  { id: 'co-white-choc', name: 'White Chocolate Cookie', shortName: 'White Choc', category: 'cookies', subcategory: 'single', price: 65, unit: 'piece', image: img('/images/coconut-cookie.jpg'), description: 'Creamy white chocolate chunks', inStock: true, isBestseller: false },
  { id: 'co-classic', name: 'Classic Choc Chip Cookie', shortName: 'Classic', category: 'cookies', subcategory: 'single', price: 55, unit: 'piece', image: img('/images/real-triple-choc-cookies.jpg'), description: 'Timeless chocolate chip perfection', inStock: true, isBestseller: false },
  { id: 'co-red-velvet', name: 'Red Velvet Cookie', shortName: 'Red Velvet', category: 'cookies', subcategory: 'single', price: 70, unit: 'piece', image: img('/images/red-velvet-cookie.jpg'), description: 'Red velvet with white choc chips', inStock: true, isBestseller: false },
  { id: 'co-pistachio', name: 'Pistachio & Rose Biscuits', shortName: 'Pistachio Rose', category: 'cookies', subcategory: 'single', price: 90, unit: 'piece', image: img('/images/real-pistachio-biscuits.jpg'), description: 'Elegant pistachio cookies with rose', inStock: true, isBestseller: true },
  ...
  { id: 'co-coconut', name: 'Coconut Cookie', shortName: 'Coconut', category: 'cookies', subcategory: 'single', price: 65, unit: 'piece', image: img('/images/coconut-cookie.jpg'), description: 'Toasted coconut flavour in every bite', inStock: true, isBestseller: false },
  { id: 'co-box-6', name: 'Cookie Box (6 pcs)', shortName: 'Cookie Box 6', category: 'cookies', subcategory: 'box', price: 360, unit: 'box', image: img('/images/real-triple-choc-cookies.jpg'), description: 'Mix & match 6 cookies of your choice', inStock: true, isBestseller: true },
  { id: 'co-box-12', name: 'Cookie Box (12 pcs)', shortName: 'Cookie Box 12', category: 'cookies', subcategory: 'box', price: 680, unit: 'box', image: img('/images/real-triple-choc-cookies.jpg'), description: 'Mix & match 12 cookies — great for gifting', inStock: true, isBestseller: false },
