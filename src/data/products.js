...
export const products = [
  ...
  { id: 'cs-nutella', name: 'Nutella Cheesecake Slice', shortName: 'Nutella', category: 'cheesecake', subcategory: 'slice', subgroup: 'chocolate', flavourKey: 'nutella', price: 150, unit: 'slice', image: img('/images/nutella-dessert.jpg'), description: 'Swirled with real Nutella throughout', inStock: true, isBestseller: true },
  ...
  { id: 'cb-nutella', name: 'Nutella Banto Cake', shortName: 'Nutella Banto', category: 'cheesecake', subcategory: 'banto', subgroup: 'chocolate', flavourKey: 'nutella', price: 440, unit: 'banto', image: img('/images/nutella-dessert.jpg'), description: 'Banto 4" · 3 slices · 300–350 gm', inStock: true, isBestseller: true },
  { id: 'cb-biscoff', name: 'Biscoff Banto Cake', shortName: 'Biscoff Banto', category: 'cheesecake', subcategory: 'banto', subgroup: 'chocolate', flavourKey: 'biscoff', price: 410, unit: 'banto', image: img('/images/biscoff-cake.jpg'), description: 'Banto 4" · 3 slices · 300–350 gm', inStock: true, isBestseller: true },
