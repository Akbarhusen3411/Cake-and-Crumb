...
export const products = [
  ...
  // Exotic
  { id: 'cs-mango', name: 'Mango Cheesecake Slice', shortName: 'Mango', category: 'cheesecake', subcategory: 'slice', subgroup: 'exotic', flavourKey: 'mango', price: 120, unit: 'slice', image: img('/images/mango-dessert.jpg'), description: 'Tropical Alphonso mango on creamy base', inStock: true, isBestseller: false },
  { id: 'cs-passionfruit', name: 'Passion Fruit Cheesecake Slice', shortName: 'Passion Fruit', category: 'cheesecake', subcategory: 'slice', subgroup: 'exotic', flavourKey: 'passionfruit', price: 130, unit: 'slice', image: img('/images/passion-fruit.jpg'), description: 'Exotic passion fruit with a tangy twist', inStock: true, isBestseller: false },
  { id: 'cs-cherry', name: 'Cherry Cheesecake Slice', shortName: 'Cherry', category: 'cheesecake', subcategory: 'slice', subgroup: 'exotic', flavourKey: 'cherry', price: 130, unit: 'slice', image: img('/images/cherry-dessert.jpg'), description: 'Rich cherry compote over smooth cheesecake', inStock: true, isBestseller: false },
  ...
  { id: 'cs-mango-passion', name: 'Mango & Passion Cheesecake Slice', shortName: 'Mango & Passion', category: 'cheesecake', subcategory: 'slice', subgroup: 'exotic', flavourKey: 'mango-passion', price: 140, unit: 'slice', image: img('/images/mango-dessert.jpg'), description: 'The best of both tropical worlds', inStock: true, isBestseller: false },
  { id: 'cs-coconut', name: 'Coconut Cheesecake Slice', shortName: 'Coconut', category: 'cheesecake', subcategory: 'slice', subgroup: 'exotic', flavourKey: 'coconut', price: 140, unit: 'slice', image: img('/images/coconut-dessert.jpg'), description: 'Creamy coconut-infused cheesecake', inStock: true, isBestseller: false },

  // Chocolate
  { id: 'cs-chocolate', name: 'Chocolate Cheesecake Slice', shortName: 'Chocolate', category: 'cheesecake', subcategory: 'slice', subgroup: 'chocolate', flavourKey: 'chocolate', price: 130, unit: 'slice', image: img('/images/real-chocolate-cake.jpg'), description: 'Milk & dark chocolate double layer', inStock: true, isBestseller: false },
  ...
  { id: 'cs-nutella', name: 'Nutella Cheesecake Slice', shortName: 'Nutella', category: 'cheesecake', subcategory: 'slice', subgroup: 'chocolate', flavourKey: 'nutella', price: 150, unit: 'slice', image: img('/images/nutella-dessert.jpg'), description: 'Swirled with real Nutella throughout', inStock: true, isBestseller: false },
  { id: 'cs-biscoff', name: 'Biscoff Cheesecake Slice', shortName: 'Biscoff', category: 'cheesecake', subcategory: 'slice', subgroup: 'chocolate', flavourKey: 'biscoff', price: 140, unit: 'slice', image: img('/images/biscoff-cake.jpg'), description: 'Lotus Biscoff cookie butter bliss', inStock: true, isBestseller: true },
  ...
  { id: 'cb-strawberry', name: 'Strawberry Banto Cake', shortName: 'Strawberry Banto', category: 'cheesecake', subcategory: 'banto', subgroup: 'classic', flavourKey: 'strawberry', price: 350, unit: 'banto', image: img('/images/real-strawberry-cheesecake.jpg'), description: 'Banto 4" · 3 slices · 300–350 gm', inStock: true, isBestseller: false },
  ...
  { id: 'cb-passionfruit', name: 'Passion Fruit Banto Cake', shortName: 'Passion Fruit Banto', category: 'cheesecake', subcategory: 'banto', subgroup: 'exotic', flavourKey: 'passionfruit', price: 380, unit: 'banto', image: img('/images/passion-fruit.jpg'), description: 'Banto 4" · 3 slices · 300–350 gm', inStock: true, isBestseller: false },
  { id: 'cb-cherry', name: 'Cherry Banto Cake', shortName: 'Cherry Banto', category: 'cheesecake', subcategory: 'banto', subgroup: 'exotic', flavourKey: 'cherry', price: 380, unit: 'banto', image: img('/images/cherry-dessert.jpg'), description: 'Banto 4" · 3 slices · 300–350 gm', inStock: true, isBestseller: false },
  ...
  { id: 'cb-mango-passion', name: 'Mango & Passion Banto Cake', shortName: 'Mango & Passion Banto', category: 'cheesecake', subcategory: 'banto', subgroup: 'exotic', flavourKey: 'mango-passion', price: 410, unit: 'banto', image: img('/images/mango-dessert.jpg'), description: 'Banto 4" · 3 slices · 300–350 gm', inStock: true, isBestseller: false },
  { id: 'cb-coconut', name: 'Coconut Banto Cake', shortName: 'Coconut Banto', category: 'cheesecake', subcategory: 'banto', subgroup: 'exotic', flavourKey: 'coconut', price: 410, unit: 'banto', image: img('/images/coconut-dessert.jpg'), description: 'Banto 4" · 3 slices · 300–350 gm', inStock: true, isBestseller: false },
  ...
  { id: 'cb-nutella', name: 'Nutella Banto Cake', shortName: 'Nutella Banto', category: 'cheesecake', subcategory: 'banto', subgroup: 'chocolate', flavourKey: 'nutella', price: 440, unit: 'banto', image: img('/images/nutella-dessert.jpg'), description: 'Banto 4" · 3 slices · 300–350 gm', inStock: true, isBestseller: false },
  { id: 'cb-biscoff', name: 'Biscoff Banto Cake', shortName: 'Biscoff Banto', category: 'cheesecake', subcategory: 'banto', subgroup: 'chocolate', flavourKey: 'biscoff', price: 410, unit: 'banto', image: img('/images/biscoff-cake.jpg'), description: 'Banto 4" · 3 slices · 300–350 gm', inStock: true, isBestseller: false },
  ...
  // Milk Cake 6" — Whole
  { id: 'ck-milk-biscoff', name: 'Biscoff Milk Cake', shortName: 'Biscoff Milk Cake', category: 'cakes', subcategory: 'milk-cake', price: 800, unit: 'whole', image: img('/images/biscoff-cake.jpg'), description: 'Moist milk cake soaked in Biscoff goodness', inStock: true, isBestseller: false },
  ...
  // Bakes & Treats
  { id: 'ck-brownie', name: 'Fudge Brownie', shortName: 'Brownie', category: 'cakes', subcategory: 'treats', price: 80, unit: 'piece', image: img('/images/real-brownies.jpg'), description: 'Dense, fudgy chocolate brownie', inStock: true, isBestseller: false },
  ...
  { id: 'co-pistachio', name: 'Pistachio & Rose Cookie', shortName: 'Pistachio Rose', category: 'cookies', subcategory: 'single', price: 70, unit: 'piece', image: img('/images/real-pistachio-biscuits.jpg'), description: 'Elegant pistachio cookies with rose', inStock: true, isBestseller: false },
  { id: 'co-box-6', name: 'Cookie Box (6 pcs)', shortName: 'Cookie Box 6', category: 'cookies', subcategory: 'box', price: 340, unit: 'box', image: img('/images/real-triple-choc-cookies.jpg'), description: 'Mix & match 6 cookies (₹280–₹400 by flavour)', inStock: true, isBestseller: false },
  ...
  { id: 'ds-cheesecake-cup', name: 'Cheesecake Cup', shortName: 'Cheesecake Cup', category: 'desserts', subcategory: 'cups', price: 150, unit: 'cup', image: img('/images/real-biscoff-cups.jpg'), description: 'Mini cheesecake in a cup with topping', inStock: true, isBestseller: false },
  ...
  { id: 'dr-blue-lagoon', name: 'Blue Lagoon Mojito', shortName: 'Blue Lagoon', category: 'drinks', subcategory: 'mojitos', price: 120, unit: 'glass', image: img('/images/blue-lagoon.jpg'), description: 'Electric blue citrus cooler', inStock: true, isBestseller: false },
  ...
  { id: 'dr-shake-biscoff', name: 'Biscoff Milkshake', shortName: 'Biscoff Shake', category: 'drinks', subcategory: 'milkshakes', price: 180, unit: 'glass', image: img('/images/milkshake-drink.jpg'), description: 'Thick Biscoff cookie butter shake', inStock: true, isBestseller: false },
