...
export const menuCategories = [
  {
    ...
    priceLabel: '₹120 – ₹170 / slice  |  ₹350 – ₹500 / banto cake',
    note: '*Customisable flavours available on request*',
    items: [
      'Strawberry', 'Blueberry', 'Raspberry', 'Orange Creamsicle', 'Lemon', 'Rose',
      'Mango', 'Passion Fruit', 'Cherry', 'Guava',
      'Mango & Passion', 'Coconut',
      'Chocolate (Milk & Dark)', 'Chocolate Orange', 'Black Forest', 'Chocolate Chunk',
      'Nutella', 'Biscoff',
      'Cookies & Cream', 'Caramel', 'Coffee', 'Pistachio', 'Dubai Special',
    ],
  },
  {
    id: 'cakes',
    ...
    subcategories: [
      ...
      },
      {
        ...
        items: ['Biscoff', 'Trés Léches', 'Rose', 'Turkish', 'Chocolate', 'Raspberry', 'Pistachio'],
      },
      {
        title: 'Bakes',
      ...
      },
      {
        title: 'Platters',
        price: '₹170 per stack',
        items: ['Pancakes (stack of 3)', 'Crêpes (stack of 3)'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      'Macarons — ₹120', 'Dipped Cheesecake Slice — ₹200',
      'Rice Krispies Treats — ₹90',
